...
enum { HC_INVAL = 0, HC_IPC = 1, HC_REQUEST_MEM_ACCESS = 2, HC_REVOKE_MEM_ACCESS = 3, HC_GET_CPU_ID = 4, HC_NOTIFY_CPU = 5, HC_EMPTY_CALL = 6, HC_REQUEST_MEM_ACCESS_TIMER = 7, HC_DISPLAY_STRING = 8, HC_MEASURE_IPI = 9, HC_REVOKE_MEM_ACCESS_TIMER = 10 };
